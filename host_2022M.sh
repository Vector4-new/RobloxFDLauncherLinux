...
if [[ "$(cat settings/server/assetSaving.txt)" == "true" ]]; then
    cp -R templates/assetsaving/SaveAssets/* /home/twig/RobloxFDLauncherLinux/Webserver_2022M/www/
else
    cp -R templates/assetsaving/DontSave/* /home/twig/RobloxFDLauncherLinux/Webserver_2022M/www/
fi
...
(cat "$2" > /home/$USER/RobloxFDLauncherLinux/Webserver_2022M/www/.127.0.0.1/asset/1818) &> /dev/null
(cat "$2" > /home/$USER/RobloxFDLauncherLinux/Webserver_2022M/www/.localhost/asset/1818) &> /dev/null
